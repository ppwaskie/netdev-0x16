...
\newline
\newline
In the HPC space, RDMA-based technologies can continue converging to more common protocol and hardware technologies.  Promising technologies such as {\small \texttt{io\_uring}}, and new protocols such as Homa \cite{homa}, continue to narrow the gap between highly customized networks, and something that the kernel can provide out of the box.
\newline
\newline
